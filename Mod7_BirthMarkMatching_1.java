...
public class Mod7_BirthMarkMatching_1 {
...
//read large mered graph
 // read the graph from the file
         ...
         File file1 = new File("FSM_SUBGRAPH_SELECTED_python1");
         String filepath1="FSM_SUBGRAPH_SELECTED_python1";
         String list1[];
         
          File file2 = new File("FSM_SUBGRAPH_SELECTED_python1");
         String filepath2="FSM_SUBGRAPH_SELECTED_python1";
         String list2[];
