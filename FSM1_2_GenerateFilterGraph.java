...
public class FSM1_2_GenerateFilterGraph {
    ...
    public static int LIMIT=6;
      ...
      public static void MAIN() throws FileNotFoundException, IOException{
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                System.out.println("getSelectedFile() : " + chooser.getSelectedFile()+"  "+chooser.getSelectedFile().getName());
                //System.out.println("getSelectedFile() : " + chooser.getName().lastIndexOf("/"));
            }
            else {
